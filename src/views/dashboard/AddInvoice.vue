  ...
  <div class="page-add-invoice">
    <nav class="breadcrumb" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active"><router-link to="/dashboard/invoices/add-invoice" aria-current="true">Add invoice</router-link></li>
      </ul>
    </nav>
    <div class="column is-multiline">
      ...
      <div class="column is-12">
        ...
        <div class="select">
          <select name="client" v-model="invoice.client">
            ...
            <option v-for="client in clients" v-bind:key="client.id" v-bind:value="client">{{ client.name }}</option>
          </select>
        </div>
        <div class="box mt-4" v-if="invoice.client">
          ...
          <p v-if="invoice.client.zipcode || invoice.client.place">
            {{ invoice.client.zipcode }}-{{ invoice.client.Place }}</p>
      ...
      <div class="column is-12">
        ...
        <ItemForm v-for="item in invoice.items" v-bind:key="item.item_num"
                  v-bind:initialItem="item" v-on:updatePrice="updateTotals"></ItemForm>
