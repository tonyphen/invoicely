  ...
  <div class="page-client">
    <nav class="breadcrumb" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active">
          <router-link to="/dashboard/clients" aria-current="true">Clients</router-link>
        </li>
      </ul>
    </nav>
    <div class="columns is-multiline">
      ...
      <div class="column is-3" v-for="client in clients" v-bind:key="client.id">
        <div class="box">
          ...
          <router-link :to="{ name: 'Client', params: { id: client.id}}" class="button is_light">Detail</router-link>
        </div>
      </div>
    </div>
  </div>
